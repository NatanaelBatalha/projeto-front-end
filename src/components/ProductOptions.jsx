...
const ProductOptions = () => {
    ...
    return ( 
        <ProducOptionsContainer>
            ...
            <nav>
                <div className="frameTotal1">
                    <p className="filtro">Categoria</p>
                    <div className="frameTexto">
                        <p className="texto">Esporte e lazer</p>
                        <Checkbox onChange={e => setChecked(e.checked)} checked={checked}></Checkbox>
                    </div>
                    <div className="frameTexto">
                        <p className="texto">Casual</p>
                        <Checkbox onChange={e => setChecked(e.checked)} checked={checked}></Checkbox>
                    </div>
                    <div className="frameTexto">
                        <p className="texto">Utilitário</p>
                        <Checkbox onChange={e => setChecked(e.checked)} checked={checked}></Checkbox>
                    </div>
                    <div className="frameTexto">
                        <p className="texto">Unisex</p>
                        <Checkbox onChange={e => setChecked(e.checked)} checked={checked}></Checkbox>
                    </div>
                </div>
            </nav>
            <nav>
                <div className="frameTotal1">
                    <p className="filtro">Gênero</p>
                    <div className="frameTexto">
                        <p className="texto">Masculino</p>
                        <Checkbox onChange={e => setChecked(e.checked)} checked={checked}></Checkbox>
                    </div>
                    <div className="frameTexto">
                        <p className="texto">Feminino</p>
                        <Checkbox onChange={e => setChecked(e.checked)} checked={checked}></Checkbox>
                    </div>
                    <div className="frameTexto">
                        <p className="texto">Unisexs</p>
                        <Checkbox onChange={e => setChecked(e.checked)} checked={checked}></Checkbox>
                    </div>
                </div>
            </nav>
